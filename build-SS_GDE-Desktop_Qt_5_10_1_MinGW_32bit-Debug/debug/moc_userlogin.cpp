...
#include "../../SS_GDE/UserLgoin/userlogin.h"
...
QT_MOC_LITERAL(1, 10, 14), // "sigUserLoginOk"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12) // "slotBtnLogin"

    },
    "UserLogin\0sigUserLoginOk\0\0slotBtnLogin"
};
...
void UserLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigUserLoginOk(); break;
        case 1: _t->slotBtnLogin(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (UserLogin::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserLogin::sigUserLoginOk)) {
                *result = 0;
                return;
            }
        }
